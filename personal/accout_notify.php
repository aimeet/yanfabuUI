      ...
      <div class="page-wrapper">
       <div class="alert alert-info">
         ...
         <div class="control-group">
             <label class="control-label" for="mailCheck"><span class="icon-mail"></span>&nbsp;电子邮件</label>
              <div class="controls">
          ...
          <div class="control-group">
             <label class="control-label" for="msgCheck"><span class="icon-msg"></span>&nbsp;站内通知</label>
              <div class="controls">
          ...
          <div class="control-group">
             <label class="control-label"><span class="icon-users"></span>&nbsp;对象</label>
              <div class="controls">
                 <select>
          ...
          <div class="control-group">
             <label class="control-label"><span class="icon-layout"></span>&nbsp;应用</label>
              <div class="controls">
