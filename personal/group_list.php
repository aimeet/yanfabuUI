...
<title>圈子-研发埠|yanfabu.com-研发创新互动平台</title>
        ...
        <?php include '../library/left_menu.php'; ?>
          ...
          <div class="title-header channel-header">
            ...
            <ul class="nav nav-tabs">
                <li><a href="group_post.php" title="">讨论话题(10)</a></li>
                <li class="active"><a href="group_list.php" title="">我的圈子(12)</a></li>
            </ul>
          </div>
          <div class="row-fluid">
          ...
          <div class="page-content pull-left">
            <div class="l-notop15">
                  ...
                  <div class="row-fluid search-inline">
                          <a class="btn pull-right" href="../post_list.php"><span class="icon-layout"></span>全部讨论</a>
                          <a class="btn btn-info pull-right" href="../post.php"><span class="icon-plus"></span>创建讨论</a>
                  ...
                  {
                  echo '<div class="media" id="media_'.$row["id"].'"><a href="#" role="button" class="del-link" title="退出朋友圈" id="del-'.$row["id"].'">×</a><a class="pull-left" href="#" ><img class="avatar-img" src="../images/photo/no_topic.png" width="80" height="80"></a>';
                  echo '<div class="media-body"><h4 class="media-heading"><a class="question_link" target="_blank" href="../group.php">'.$row["name"].'</a></h4>';
                  echo '<div class="media-detail">'.$row["detail"].'</div><div class="media-bar"><span class="time">03-29 18:40</span><a href="" title="103个讨论话题" class="msg_add_q"><span class="icon-chat"></span>103个讨论话题</a><a href="" title="202个回答"><span class="icon-user"></span>2人申请加入</a><a href="../group_user.php" ><span class="icon-users"></span>圈子成员5人</a></div></div></div>';
				   }
