...
<?php
	...
	//MySQL query
	$Result = mysql_query("SELECT id, name, detail FROM topic_list order by id asc limit 3");
      ...
      <div class="g-notop-line b-sbg clearfix"> 
        ...
        <?php include '../library/left_menu.php'; ?>
          ...
          <div class="title-header channel-header">
            <h2 class="title">关注的领域</h2>
            <ul class="nav nav-tabs">
                <li><a href="topic_tag.php" title="">我创建的领域(12)</a></li>
                <li class="active"><a href="ask_topic.php" title="">关注的领域(10)</a></li>
            </ul>
          </div>
          <div class="row-fluid">
          ...
          <div class="page-content pull-left">
            <div class="l-notop15">
                  ...
                  <div class="row-fluid search-inline">
                          <a class="btn pull-right" href="#"><span class="icon-layout"></span>全部领域</a>
                          <a class="btn btn-info pull-right" href="topic_add.php"><span class="icon-plus"></span>添加领域</a>
                        <div class="search-append ipt-r2">
                          <form class="side-search" action="#">
                             <input type="text" name="" value="" placeholder="该用户的领域" class="top-search-ipt input-block-level w348" />
                  ...
                  {
                  echo '<div class="media" id="media_'.$row["id"].'"><a href="#" role="button" class="del-link" title="取消收藏" id="del-'.$row["id"].'">×</a><a class="pull-left" href="#" ><img class="avatar-img" src="../images/photo/no_topic.png" width="80" height="80"></a>';
