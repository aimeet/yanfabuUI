      ...
      <div class="g-notop-line b-sbg clearfix"> 
        ...
        <div class="main-panel w-bg l-border">
          <div class="title-header channel-header">
            <h2 class="title">领域</h2>
            <ul class="nav nav-tabs">
              <li><a href="collect_list.php">收藏(5)</a></li>
              <li class="active"><a href="topic_list.php">领域(3)</a></li>
              <li><a href="draft_list.php">草稿(2)</a></li>
              <li><a href="answer_list.php">回答(12)</a></li>
          ...
          <div class="page-content pull-left">
            <div class="l-notop15">
                  <div class="title-header">
                      <ul class="nav nav-tabs">
                          <li><a href="topic_list.php" title="">我关注的领域(10)</a></li>
                          <li class="active"><a href="tag_list.php" title="">我创建的标签(12)</a></li>
                       </ul>
                   </div>
                      ...
                      <div class="media-content topic-list">
					    ...
					    <div class="media">
                          <div class="media-body">
                            ...
                            <div class="media-bar">
                              <a href="" title="" ><span class="ui-icon icon-edit"></span>编辑</a>
                            </div>
                          </div><!-- end:media-body --> 
                        </div><!-- end:media-->
