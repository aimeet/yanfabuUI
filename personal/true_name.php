...
<title>修改真实姓名-研发埠|yanfabu.com-研发创新互动平台</title>
  ...
  <div class="g-notop-line b-sbg clearfix"> 
    <!--_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/ start:左侧菜单 _/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/-->      <div class="ui-sidebar pull-left">
      ...
      <div class="title-header channel-header g_b_line">
        <h2 class="title"><a href="#">账户设定</a>&nbsp;/&nbsp;修改登陆邮箱</h2>
      </div>
      <!--end:channel-header-->
      ...
      <div class="progressbox">
         <ul class="progress-1">
             ...
             <li class="step-2"><b></b>2.修改真实姓名</li>
             <li class="step-3">3.完成</li>
         </ul>
     </div>
     
      <form class="form-horizontal top20" action="true_name2.php">
        <div class="page-wrapper min-wrap">
          <div class="push h30"></div>
              <div class="control-group">
                   <label class="control-label">登陆密码</label>
                   <div class="controls">
                      <input type="password" class="input-xlarge" value="" name="introduce" >
                   </div>
        ...
        <div class="form-actions">
            <a href="accout.php" class="btn">&nbsp;&nbsp;取消&nbsp;&nbsp;</a>
