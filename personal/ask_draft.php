            ...
            <div class="l-notop15">
                  <div class="title-header">
                      <ul class="nav nav-tabs">
                          <li class="active"><a href="#" title="">问题(10)</a></li>
                          <li><a href="#" title="">回答(12)</a></li>
                       </ul>
                   </div>
                      ...
                      <div class="media-content">
					    <div class="media">
                          <div class="media-body">
                            <h4 class="media-heading"><a class="question_link" target="_blank" href="#">在FLUENT运行过程中，经常会出现“turbulence viscous rate”超过了极限值，如何解决？</a></h4>
                            <div class="media-bar">
                              <span class="time">03-29 18:40</span>
                              <a href="" title="编辑" class="msg_add_q"><span class="ui-icon icon-edit"></span>编辑</a>
                              <a href="" title="删除" class="msg_add_error"><span class="ui-icon icon-remove"></span>删除</a>
                            </div>
                          </div><!-- end:media-body --> 
                        </div><!-- end:media-->
