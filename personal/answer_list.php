      ...
      <div class="g-notop-line b-sbg clearfix"> 
        ...
        <div class="main-panel w-bg l-border">
          <div class="title-header channel-header">
            <h2 class="title">我的回答</h2>
            <ul class="nav nav-tabs">
              <li><a href="collect_list.php">收藏(5)</a></li>
              <li><a href="topic_list.php">领域(3)</a></li>
              <li><a href="draft_list.php">草稿(2)</a></li>
              <li class="active"><a href="answer_list.php">回答(12)</a></li>
              <li><a href="ask_list.php">问题(10)</a></li>
            </ul>
          </div>
          <div class="row-fluid">
          ...
          <div class="page-content pull-left">
           <div class="l-notop15">
                 ...
                 <div class="media-content">
                    <div class="media"><a class="pull-left scan-num" href="#" ><strong>5</strong>赞同</a>
                       <div class="media-body">
                         ...
                         <div class="media-bar">
                            ...
                            <a href="" title="分享" class="msg_add_q"><span class="ui-icon icon-share"></span>分享</a>
                            <a href="" title="收藏" class="msg_add_error"><span class="ui-icon icon-file"></span>归档</a>
                         </div>
                       </div><!-- end:media-body --> 
                    </div><!-- end:media-->
