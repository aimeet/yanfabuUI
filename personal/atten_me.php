...
<title>关注-研发埠|yanfabu.com-研发创新互动平台</title>
  ...
  <div class="ui-wrapper">
    <div class="g-notop-line b-sbg clearfix"> 
      ...
      <div class="ui-sidebar pull-left">
        ...
        <?php include '../library/atten_tab.php'; ?>
        <div class="page-wrapper">
          <div class="row-fluid">
             ...
             <span class="span2">
                <div class="dropdown">
                      <a class="btn dropdown-toggle" data-toggle="dropdown" href="#"><span class="icon-resize-vertical"></span>排序<b class="caret"></b></a>
          ...
          <div class="wrap profiles attens " >
            <div class="row-fluid min-wrap top15">
            <ul class="profile-list">
             
              <li class="isotope-item">
                <div class="card">
                  <div class="face title-face"><a href="../people/index.php"><div class="active-txt clr-user">陈</div></a></div>
                  <div class="follow-con"><a tabindex="-1" href="#" class="follow-group" title="设置"><span class="icon-plus"></span></a></div>
                </div>
                <h4 class="name"><a tabindex="-1" href="#topic/explorehoney/posts" title="">陈晓军</a></h4>
                <ul class="meta-txt">
                  <li class="posts-tally">一句话介绍</li>
                </ul>
              </li>
             
             <li class="isotope-item">
                <div class="card">
                  <div class="face title-face"><a href="../people/index.php"><div class="active-txt clr-user">王</div></a></div>
                  <div class="follow-con"><a tabindex="-1" href="#" class="follow-group" title="设置"><span class="icon-plus"></span></a></div>
                </div>
                <h4 class="name"><a tabindex="-1" href="#topic/explorehoney/posts" title="">王威</a></h4>
                <ul class="meta-txt">
                  <li class="posts-tally">一句话介绍</li>
                </ul>
              </li>
              ...
              <li class="isotope-item">
                <div class="card">
                  <div class="face title-face"><div class="active-txt clr-user">陈</div></div>
                  <div class="follow-con"><a tabindex="-1" href="#" class="follow-group" title="设置"><span class="icon-plus"></span></a></div>
                </div>
                <h4 class="name"><a tabindex="-1" href="#topic/explorehoney/posts" title="">陈晓军</a></h4>
                <ul class="meta-txt">
             ...
             <li class="isotope-item">
                <div class="card">
                  <div class="face title-face"><div class="active-txt clr-user">王</div></div>
                  <div class="follow-con"><a tabindex="-1" href="#" class="follow-group" title="设置"><span class="icon-plus"></span></a></div>
                </div>
                <h4 class="name"><a tabindex="-1" href="#topic/explorehoney/posts" title="">王威</a></h4>
                <ul class="meta-txt">
...
<script type="text/javascript">	 
   require(['jquery','../plug_ins/tree/datasourceTree','MyUI/all'], function ($,DataSourceTree) {
	    // TREE
	var dataSourceTree = new DataSourceTree({
		data: [
					{ name: '我的收藏夹', type: 'folder', additionalParameters: { id: 'F1' } },
					{ name: '子收藏夹2', type: 'item', additionalParameters: { id: 'I1' } },
